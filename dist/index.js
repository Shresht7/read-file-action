...
function action() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (config_1.type) {
            contents = (0, helpers_1.parseFile)(contents, config_1.type);
        }
...
__exportStar(__nccwpck_require__(237), exports);
...
/** Parse file contents */
function parseFile(contents, as) {
    let result; //  Variable to hold the parsed results
    switch (as) {
...
function readFile(src) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, is_url_superb_1.default)(src)
            ? readFromURL(src)
            : readFromFile(src);
    });
}
